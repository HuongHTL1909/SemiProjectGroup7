...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="discount" class="col-form-label">Sale(%)</label>
        ...
        <div class="form-group">
          ...
          <input id="quantity" type="text" name="size[]" min="0" placeholder="Enter size"  value="{{$product->size}}" class="form-control">
          @error('stock')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
