    ...
    <div class="card-body">
      <form method="post" action="{{route('shipping.update',$shipping->id)}}">
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Name of the transport unit<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Transport fee<span class="text-danger">*</span></label>
