    ...
    <div class="card-header py-3">
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item"><a href="{{ route('shipping.index') }}">Transport</a></li>
                <li class="breadcrumb-item active">List</li>
            </ol>
        </div>
      <a href="{{route('shipping.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i>Create</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>ID</th>
              <th>Name of the transport unit</th>
              <th>Transport fee</th>
              <th>Status</th>
              <th>Option</th>
            </tr>
        ...
        @else
          <h6 class="text-center">No data, please create a new one</h6>
        @endif
      </div>
    </div>
</div>
