    ...
    <div class="card-header py-3">
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('post-tag.index') }}">Card</a></li>
                    <li class="breadcrumb-item active">List</li>
                </ol>
            </div>
      <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i>Create</a>
    </div>
    <div class="card-body">
