...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('admin')}}" style="color:#999">Home page</a></li>
         <li><a href="" class="active text-primary">Update account</a></li>
     </ul>
   </div>
   <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="role" class="col-form-label">Access rights</label>
