...
class CartController extends Controller
{
    ...
    public function singleAddToCart(Request $request){
        ...
        if ( ($request->quant[1] < 1) || empty($product) ) {
            request()->session()->flash('error','Quantity must be more than 1!');
            return back();
        }
        ...
        if($already_cart) {
            ...
            if ($already_cart->product->stock < $already_cart->quantity || $already_cart->product->stock <= 0) return back()->with('error','This product is out of stock!');
