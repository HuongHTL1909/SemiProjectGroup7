...
class CouponController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if($coupon){
            ...
            if($status){
                request()->session()->flash('success','Delete data successfully');
            }
            else{
                request()->session()->flash('error','An error cannot be deleted');
            }
            return redirect()->route('coupon.index');
        }
        else{
            request()->session()->flash('error','Data does not exist');
    ...
    public function couponStore(Request $request){
        ...
        // dd($coupon);
        if(!$coupon){
            request()->session()->flash('error','Discount code does not exist!');
            return back();
        }
        if($coupon){
            ...
            request()->session()->flash('success','Apply discount code successfully!');
            return redirect()->back();
        }
    }
}
